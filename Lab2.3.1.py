...
def parse_auth_line(line):
    ...
    if " from " in line:
        try:
            ...
            ip = None
        #Make ts_str to make date into string not integers
    return ts_str, ip, event_type
...
if __name__ == "__main__":
    ...
    # quick print
    print(json.dumps({k: [str(t) for t in v] for k, v in per_ip_timestamps.items()}, indent=2))